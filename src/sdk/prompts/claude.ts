...
import { buildJsonOutputSection } from '../prompt-sections.js';

/**
 * Builds Claude's system prompt for hunk-based analysis.
 */
export function buildClaudeHunkSystemPrompt(skill: SkillDefinition): string {
  const sections = [
    `<role>
