...
import { parseFileDiff, expandDiffContext, formatHunkForAnalysis, } from '../diff/index.js';
 ...
 */
function buildHunkUserPrompt(hunkCtx) {
 ...
 */
function parseHunkOutput(result, filename) {
    ...
    return findings
        ...
        if (typeof f === 'object' && f !== null && 'location' in f) {
            ...
            if (obj['location'] && typeof obj['location'] === 'object') {
                obj['location'] = { ...obj['location'], path: filename };
            }
        }
        return f;
    })
 ...
 */
async function analyzeHunk(skill, hunkCtx, repoPath, options) {
 ...
 */
export async function analyzeFile(skill, file, repoPath, options = {}, callbacks) {
