...
let _homedir = null;
let _join = null;
const dynamicImport = (specifier) => __webpack_require__(29930)(__rewriteRelativeImportExtension(specifier));
...
/* harmony export */ });
/* harmony import */ var _env_api_keys_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41900);
/* harmony import */ var _models_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18132);
/* harmony import */ var _session_resources_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(49241);
/* harmony import */ var _utils_diagnostics_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(79643);
/* harmony import */ var _utils_event_stream_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48036);
/* harmony import */ var _utils_headers_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(10325);
/* harmony import */ var _openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(43319);
/* harmony import */ var _openai_responses_shared_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(53108);
/* harmony import */ var _simple_options_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(46931);
var __rewriteRelativeImportExtension = (undefined && undefined.__rewriteRelativeImportExtension) || function (path, preserveJsx) {
    if (typeof path === "string" && /^\.\.?\//.test(path)) {
        return path.replace(/\.(tsx)$|((?:\.d)?)((?:\.[^./]+?)?)\.([cm]?)ts$/i, function (m, tsx, d, ext, cm) {
            return tsx ? preserveJsx ? ".jsx" : ".js" : d && (!ext || !cm) ? m : (d + ext + "." + cm.toLowerCase() + "js");
...
let _os = null;
const dynamicImport = (specifier) => __webpack_require__(65325)(__rewriteRelativeImportExtension(specifier));
const NODE_OS_SPECIFIER = "node:" + "os";
if (typeof process !== "undefined" && (process.versions?.node || process.versions?.bun)) {
    dynamicImport(NODE_OS_SPECIFIER).then((m) => {
        _os = m;
