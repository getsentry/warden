...
/* harmony import */ var _earendil_works_pi_ai__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(76038);
...
/* harmony import */ var _offline_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8695);
/**
 * Pi runtime adapter.
 *
...
async function refreshSelectedProviderCatalog(modelRuntime, providerId, abortSignal) {
    ...
    if ((0,_offline_js__WEBPACK_IMPORTED_MODULE_8__/* .isWardenOffline */ .XK)()) {
...
function toPiCustomTools(tools, executeTool) {
    ...
    return tools.map((tool) => (0,_earendil_works_pi_coding_agent__WEBPACK_IMPORTED_MODULE_0__.defineTool)({
        ...
        parameters: _earendil_works_pi_ai__WEBPACK_IMPORTED_MODULE_11__.Type.Unsafe(tool.inputSchema),
