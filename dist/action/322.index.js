...
async function runPiPrompt(options) {
    ...
    function startToolSpan(event) {
        try {
            const parentSpan = _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.getActiveSpan */ .sQ.getActiveSpan();
    ...
    function finishToolSpan(event) {
        try {
            ...
            span.end();
            (0,_sentry_trace_js__WEBPACK_IMPORTED_MODULE_3__/* .recordTracedSpan */ .hb)(span);
        }
        catch {
            // Telemetry should never break the workflow.
        }
 ...
 */
function startTracedSpan(options, callback) {
...
function recordTracedSpan(span) {
...
function emitFixGateMetrics(skill, checked, strippedDeterministic, strippedSemantic, semanticUnavailable) {
    safeEmit(() => {
        ...
        _sentry_node__WEBPACK_IMPORTED_MODULE_11__.count('warden.fix_gate.checked', checked, { attributes: attrs });
        _sentry_node__WEBPACK_IMPORTED_MODULE_11__.count('warden.fix_gate.stripped_deterministic', strippedDeterministic, { attributes: attrs });
        _sentry_node__WEBPACK_IMPORTED_MODULE_11__.count('warden.fix_gate.stripped_semantic', strippedSemantic, { attributes: attrs });
        _sentry_node__WEBPACK_IMPORTED_MODULE_11__.count('warden.fix_gate.semantic_unavailable', semanticUnavailable, { attributes: attrs });
    });
}
...
/* harmony export */ });
/* unused harmony exports normalizeSeverity, SeveritySchema, ConfidenceSchema, CONFIDENCE_ORDER, filterFindingsBySeverity, filterFindingsByConfidence, SourceSnippetLineSchema, FileReportSchema, ErrorCodeSchema, isExtractionErrorCode, HunkFailureSchema, TraceSpanSchema, PullRequestActionSchema, FileChangeSchema, DiffContextSourceSchema, PullRequestContextSchema, RepositoryContextSchema, RetryConfigSchema */
