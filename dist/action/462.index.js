...
/* harmony import */ var _models_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15403);
/* harmony import */ var _utils_error_body_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(298);
/* harmony import */ var _utils_event_stream_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(57868);
/* harmony import */ var _utils_headers_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(70957);
/* harmony import */ var _utils_provider_env_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(81844);
/* harmony import */ var _utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(76994);
/* harmony import */ var _google_shared_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(39517);
/* harmony import */ var _simple_options_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(402);
...
const streamSimple = (model, context, options) => {
    const base = (0,_simple_options_js__WEBPACK_IMPORTED_MODULE_5__/* .buildBaseOptions */ .QP)(model, context, options, undefined);
...
function buildHttpOptions(model, optionsHeaders) {
    ...
    const headers = (0,_utils_headers_js__WEBPACK_IMPORTED_MODULE_6__/* .providerHeadersToRecord */ .m)({ ...model.headers, ...optionsHeaders });
    if (headers) {
...
function buildGoogleAuthOptions(env) {
    const keyFilename = (0,_utils_provider_env_js__WEBPACK_IMPORTED_MODULE_7__/* .getProviderEnvValue */ .Y)("GOOGLE_APPLICATION_CREDENTIALS", env);
...
function resolveProject(options) {
    const project = options?.project ||
        (0,_utils_provider_env_js__WEBPACK_IMPORTED_MODULE_7__/* .getProviderEnvValue */ .Y)("GOOGLE_CLOUD_PROJECT", options?.env) ||
        (0,_utils_provider_env_js__WEBPACK_IMPORTED_MODULE_7__/* .getProviderEnvValue */ .Y)("GCLOUD_PROJECT", options?.env);
    if (!project) {
...
function resolveLocation(options) {
    const location = options?.location || (0,_utils_provider_env_js__WEBPACK_IMPORTED_MODULE_7__/* .getProviderEnvValue */ .Y)("GOOGLE_CLOUD_LOCATION", options?.env);
    if (!location) {
...
function buildParams(model, context, options = {}) {
    ...
    const functionCallingMode = context.tools?.length
        ? (0,_google_shared_js__WEBPACK_IMPORTED_MODULE_2__/* .resolveGoogleFunctionCallingMode */ .hz)(context.tools, options.toolChoice, (0,_google_shared_js__WEBPACK_IMPORTED_MODULE_2__/* .supportsGoogleStrictToolSampling */ .AT)(model.id))
        : undefined;
    const config = {
        ...
        ...(context.tools && context.tools.length > 0 && { tools: (0,_google_shared_js__WEBPACK_IMPORTED_MODULE_2__/* .convertTools */ .B1)(context.tools) }),
