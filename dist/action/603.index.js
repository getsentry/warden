...
const eventstream_handler_node_1 = __webpack_require__(94851);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/models.js
var models = __webpack_require__(15403);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/diagnostics.js
var diagnostics = __webpack_require__(53475);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/error-body.js
var error_body = __webpack_require__(298);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/event-stream.js
var event_stream = __webpack_require__(57868);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/headers.js
var headers = __webpack_require__(70957);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/json-parse.js
var json_parse = __webpack_require__(43235);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/node-http-proxy.js
var node_http_proxy = __webpack_require__(61401);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/provider-env.js
var provider_env = __webpack_require__(81844);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/utils/sanitize-unicode.js
var sanitize_unicode = __webpack_require__(76994);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/api/constrained-sampling.js
var constrained_sampling = __webpack_require__(55214);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/api/simple-options.js + 1 modules
var simple_options = __webpack_require__(402);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/api/transform-messages.js
var transform_messages = __webpack_require__(56403);
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/api/bedrock-converse-stream.js
...
const stream = (model, context, options = {}) => {
    ...
    (async () => {
        ...
        const config = {
            profile: optionsProfile || (0,provider_env/* getProviderEnvValue */.Y)("AWS_PROFILE", options.env),
        };
        const configuredRegion = getConfiguredBedrockRegion(options);
        const hasAmbientConfiguredProfile = Boolean((0,provider_env/* getProviderEnvValue */.Y)("AWS_PROFILE"));
        ...
        const skipAuth = (0,provider_env/* getProviderEnvValue */.Y)("AWS_BEDROCK_SKIP_AUTH", options.env) === "1";
        const bearerToken = options.bearerToken ||
            options.apiKey ||
            (0,provider_env/* getProviderEnvValue */.Y)("AWS_BEARER_TOKEN_BEDROCK", options.env) ||
            undefined;
        ...
        if (typeof process !== "undefined" && (process.versions?.node || process.versions?.bun)) {
            ...
            const proxyUrl = (0,node_http_proxy/* resolveHttpProxyUrlForTarget */.Q)(model.baseUrl, options.env);
            if (proxyUrl) {
            ...
            else if ((0,provider_env/* getProviderEnvValue */.Y)("AWS_BEDROCK_FORCE_HTTP1", options.env) === "1") {
        ...
        try {
            ...
            const customHeaders = (0,headers/* providerHeadersToRecord */.m)(options.headers);
            if (customHeaders) {
...
function formatBedrockError(error) {
    const norm = (0,error_body/* normalizeProviderError */.Jo)(error);
...
function appendBedrockFailureDiagnostic(output, error, fallbackRequestId) {
    ...
    if (Object.keys(details).length === 0)
        return;
    (0,diagnostics/* appendAssistantMessageDiagnostic */.vF)(output, { type: "bedrock_response_failure", timestamp: Date.now(), details });
}
/**
...
const streamSimple = (model, context, options) => {
    const base = (0,simple_options/* buildBaseOptions */.QP)(model, context, options, undefined);
    ...
    if (isAnthropicClaudeModel(model)) {
        ...
        return stream(model, context, {
            ...
            thinkingBudgets: {
                ...
                [(0,simple_options/* clampReasoning */.M7)(options.reasoning)]: Math.min(adjusted.thinkingBudget, Math.max(0, maxTokens - 1024)),
            },
        });
    }
    return stream(model, context, {
...
function supportsPromptCaching(model, env) {
    ...
    if (!hasClaudeRef) {
        ...
        if ((0,provider_env/* getProviderEnvValue */.Y)("AWS_BEDROCK_FORCE_CACHE", env) === "1")
            return true;
        return false;
    }
...
function createNonBlankTextBlock(text) {
    const sanitized = (0,sanitize_unicode/* sanitizeSurrogates */.J)(text);
                ...
                for (const c of m.content) {
                    switch (c.type) {
                        ...
                        case "thinking": {
                            ...
                            const thinking = (0,sanitize_unicode/* sanitizeSurrogates */.J)(c.thinking);
...
function convertToolConfig(tools, toolChoice, supportsStrictMode) {
    ...
    const bedrockTools = tools.map((tool) => {
        const strict = (0,constrained_sampling/* resolveJsonSchemaStrictSampling */._F)(tool, supportsStrictMode);
        return {
            toolSpec: {
                name: tool.name,
...
function getConfiguredBedrockRegion(options) {
    return (options.region ||
        (0,provider_env/* getProviderEnvValue */.Y)("AWS_REGION", options.env) ||
        (0,provider_env/* getProviderEnvValue */.Y)("AWS_DEFAULT_REGION", options.env) ||
        undefined);
}
function getConfiguredBedrockCredentials(env) {
    const accessKeyId = (0,provider_env/* getProviderEnvValue */.Y)("AWS_ACCESS_KEY_ID", env);
    const secretAccessKey = (0,provider_env/* getProviderEnvValue */.Y)("AWS_SECRET_ACCESS_KEY", env);
    if (!accessKeyId || !secretAccessKey) {
        return undefined;
    }
    const sessionToken = (0,provider_env/* getProviderEnvValue */.Y)("AWS_SESSION_TOKEN", env);
    return {
        accessKeyId,
        secretAccessKey,
        ...(sessionToken ? { sessionToken } : {}),
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@earendil-works+pi-ai@0.84.1_@modelcontextprotocol+sdk@1.29.0_zod@4.4.3__ws@8.21.0_zod@4.4.3/node_modules/@earendil-works/pi-ai/dist/bedrock-provider.js
...
/* harmony import */ var _provider_env_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(81844);
