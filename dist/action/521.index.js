...
/* harmony export */ });
/* harmony import */ var _anthropic_ai_sdk__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59346);
...
// EXTERNAL MODULE: ./src/skills/resources.ts
var resources = __webpack_require__(18771);
...
async function resolveAllowedPath(checkoutPath, requestedPath, skillRoot) {
    ...
    const resourceRoot = skillRoot ? resources/* SKILL_RESOURCE_DIRECTORIES */.j
        .map((dir) => (0,external_node_path_.resolve)(skillRoot, dir))
    ...
    if (resourceRoot && skillRoot) {
        ...
        const allowedRoot = (0,external_node_path_.resolve)(canonicalSkillRoot, (0,external_node_path_.relative)((0,external_node_path_.resolve)(skillRoot), resourceRoot));
...
function confineTool(tool, checkoutPath, skillRoot) {
...
function createCheckoutFileTools(checkoutPath, toolNames, skillRoot) {
    const requestedTools = new Set(toolNames);
    const tools = [];
    if (requestedTools.has('read')) {
        tools.push(confineTool((0,dist.createReadToolDefinition)(checkoutPath), checkoutPath, skillRoot));
    }
...
async function runPiPrompt(options) {
    ...
    const checkoutFileTools = createCheckoutFileTools(options.cwd, options.toolNames.filter((toolName) => !customToolNames.has(toolName)), options.skillRoot);
...
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11825);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9604);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(49042);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(15082);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(78471);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(68724);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(15414);
/* harmony import */ var _sentry_node__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(96048);
...
async function flushSentry(timeoutMs = 30_000) {
    if (!initialized)
        return true;
    try {
        return await _sentry_node__WEBPACK_IMPORTED_MODULE_8__/* .flush */ .bX(timeoutMs);
    }
    catch {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   j: () => (/* binding */ SKILL_RESOURCE_DIRECTORIES)
/* harmony export */ });
/** Resource directories exposed by a resolved skill, excluding neighboring files. */
const SKILL_RESOURCE_DIRECTORIES = ['scripts', 'references', 'assets'];
