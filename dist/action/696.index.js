...
// EXTERNAL MODULE: ./node_modules/.pnpm/@octokit+rest@22.0.1/node_modules/@octokit/rest/dist-src/index.js + 21 modules
var dist_src = __webpack_require__(87202);
...
var dist = __webpack_require__(5998);
...
const GitHubUserSchema = schemas/* object */.Ik({
    login: schemas/* string */.Yj(),
});
const GitHubRepoSchema = schemas/* object */.Ik({
    name: schemas/* string */.Yj(),
    full_name: schemas/* string */.Yj(),
    default_branch: schemas/* string */.Yj(),
    owner: GitHubUserSchema,
});
const GitHubPullRequestSchema = schemas/* object */.Ik({
    number: schemas/* number */.ai(),
    title: schemas/* string */.Yj(),
    body: schemas/* string */.Yj().nullable(),
    user: GitHubUserSchema,
    base: schemas/* object */.Ik({
        ref: schemas/* string */.Yj(),
        sha: schemas/* string */.Yj(),
    }),
    head: schemas/* object */.Ik({
        ref: schemas/* string */.Yj(),
        sha: schemas/* string */.Yj(),
    }),
});
const GitHubEventPayloadSchema = schemas/* object */.Ik({
    action: schemas/* string */.Yj(),
...
var sdk = __webpack_require__(54692);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/nanoid@5.1.11/node_modules/nanoid/index.js
var nanoid = __webpack_require__(74160);
...
If no findings exist, return: {"findings": []}`),
    ...
    const result = await runtimes_getRuntime(runtimeName).runAuxiliary({
        ...
        apiKey,
        prompt: userContent,
        schema: schemas/* object */.Ik({ findings: schemas/* array */.YO(schemas/* unknown */.L5()) }),
        model,
...
const MergeGroupsSchema = schemas/* array */.YO(schemas/* array */.YO(schemas/* number */.ai().int()));
/**
...
const DuplicateMatchesSchema = schemas/* array */.YO(schemas/* object */.Ik({
    findingIndex: schemas/* number */.ai().int(),
    existingIndex: schemas/* number */.ai().int(),
}));
/**
...
const ConsolidationGroupsSchema = schemas/* array */.YO(schemas/* array */.YO(schemas/* number */.ai().int()));
/**
 ...
 */
async function retry_sleep(ms, abortSignal) {
...
const VerificationVerdictSchema = schemas/* object */.Ik({
    verdict: schemas/* enum */.k5(['keep', 'revise', 'reject']),
    ...
    return sentry/* Sentry.startSpan */.sQ.startSpan({
        ...
        for (let attempt = 0; attempt <= retryConfig.maxRetries; attempt++) {
            ...
            try {
                ...
                try {
                    await retry_sleep(delayMs, abortController?.signal);
                }
                catch {
...
function renderVerification(verification) {
    return `<details><summary>Evidence</summary>\n\n${(0,utils/* escapeHtml */.ZD)(verification.trim())}\n\n</details>`;
}
...
async function executeAllTriggers(matchedTriggers, octokit, context, runnerConcurrency, inputs) {
    ...
    return (0,utils/* runPool */.kD)(matchedTriggers, concurrency, (trigger) => executeTrigger(trigger, {
        octokit,
        context,
 ...
 */
async function finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reports, shouldFailAction, failureReasons, canResolveStale, triggerErrors) {
    ...
    if (coreCheckId && context.pullRequest) {
        try {
            ...
            const coreConclusion = determineCoreConclusion(shouldFailAction || triggerErrors.length > 0, outputs.findingsCount);
...
async function completeSkippedCoreCheck(octokit, context, coreCheckId, skipped) {
    ...
    try {
        await updateCoreCheck(octokit, coreCheckId, {
        ...
        sentry/* Sentry.captureException */.sQ.captureException(error, { tags: { operation: 'update_core_check_skipped' } });
        warnAction(`Failed to update core check: ${error}`);
    }
}
...
async function completeSkippedSkillChecks(octokit, context, skippedTriggers) {
    ...
    for (const trigger of skippedTriggers) {
        try {
            ...
            await updateSkillCheck(octokit, skillCheck.checkRunId, {
                skill: trigger.skill,
...
async function failUndispatchedSkillChecks(octokit, context, triggers, error) {
    ...
    for (const trigger of triggers) {
        try {
            ...
            sentry/* Sentry.captureException */.sQ.captureException(checkError, {
                tags: {
...
async function failCoreCheck(octokit, context, coreCheckId, error) {
    ...
    try {
        ...
        sentry/* Sentry.captureException */.sQ.captureException(checkError, { tags: { operation: 'fail_core_check' } });
...
async function runPRWorkflow(octokit, inputs, eventName, eventPath, repoPath) {
    return sentry/* Sentry.startSpan */.sQ.startSpan({ op: 'workflow.run', name: 'review pull_request' }, async (span) => {
        ...
        let results;
        try {
            results = await sentry/* Sentry.startSpan */.sQ.startSpan({
                op: 'workflow.execute',
        ...
        const reviewPhase = await runOrFailCore(octokit, context, coreCheckId, () => sentry/* Sentry.startSpan */.sQ.startSpan({ op: 'workflow.review', name: 'post reviews' }, () => postReviewsAndTrackFailures(octokit, context, results, inputs, auxiliaryOptions)));
        ...
        await runOrFailCore(octokit, context, coreCheckId, () => sentry/* Sentry.startSpan */.sQ.startSpan({ op: 'workflow.resolve', name: 'resolve stale comments' }, async (resolveSpan) => {
        ...
        await finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reviewPhase.reports, reviewPhase.shouldFailAction, reviewPhase.failureReasons, canResolveStale, triggerErrors);
...
function findGitRoot(startPath) {
    try {
        const root = (0,exec/* execGitNonInteractive */.rd)(['rev-parse', '--show-toplevel'], {
            cwd: (0,external_node_path_.resolve)(startPath),
        });
        return root ? (0,external_node_path_.resolve)(root) : null;
    }
    catch {
        return null;
    }
...
/* harmony import */ var _sentry_dotagents_lib__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(38979);
