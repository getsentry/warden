...
/* harmony import */ var _utils_error_body_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22191);
/* harmony import */ var _utils_event_stream_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14257);
/* harmony import */ var _utils_hash_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(12466);
/* harmony import */ var _utils_headers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41146);
...
/* harmony import */ var _utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(80279);
/* harmony import */ var _github_copilot_headers_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(70340);
/* harmony import */ var _openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(92297);
/* harmony import */ var _simple_options_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16417);
/* harmony import */ var _transform_messages_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(99994);
...
function convertMessages(model, context, compat) {
    ...
    const normalizeToolCallId = (id) => {
        ...
        if (id.includes("|")) {
            ...
            const hash = (0,_utils_hash_js__WEBPACK_IMPORTED_MODULE_10__/* .shortHash */ .B)(id).slice(0, 8);
    ...
    const transformedMessages = (0,_transform_messages_js__WEBPACK_IMPORTED_MODULE_11__/* .transformMessages */ .b)(context.messages, model, (id) => normalizeToolCallId(id));
    if (context.systemPrompt) {
        const useDeveloperRole = model.reasoning && compat.supportsDeveloperRole;
        const role = useDeveloperRole ? "developer" : "system";
        params.push({ role: role, content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(context.systemPrompt) });
    }
    let lastRole = null;
    for (let i = 0; i < transformedMessages.length; i++) {
        ...
        if (msg.role === "user") {
            if (typeof msg.content === "string") {
                params.push({
                    role: "user",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(msg.content),
                });
            }
            else {
                const content = msg.content.map((item) => {
                    if (item.type === "text") {
                        return {
                            type: "text",
                            text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(item.text),
                        };
                    }
                    else {
                        return {
            ...
            const assistantTextParts = msg.content
                ...
                .map((block) => ({
                type: "text",
                text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(block.text),
            }));
            ...
            if (nonEmptyThinkingBlocks.length > 0) {
                if (compat.requiresThinkingAsText) {
                    ...
                    const thinkingText = nonEmptyThinkingBlocks
                        .map((block) => (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(block.thinking))
                        .join("\n\n");
            ...
            for (; j < transformedMessages.length && transformedMessages[j].role === "toolResult"; j++) {
                ...
                const toolResultMsg = {
                    role: "tool",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_12__/* .sanitizeSurrogates */ .J)(toolResultText),
