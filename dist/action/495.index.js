...
/* harmony import */ var _utils_hash_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24193);
/* harmony import */ var _utils_json_parse_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(50145);
/* harmony import */ var _utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2224);
/* harmony import */ var _transform_messages_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1909);
    ...
    for (const msg of transformedMessages) {
        if (msg.role === "user") {
            ...
            if (hasImages && model.input.includes("image")) {
                ...
                output = (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeSurrogates */ .J)(hasText ? textResult : "(see attached image)");
            }
            messages.push({
