...
const importNodeModule = (specifier) => __webpack_require__(70713)(__rewriteRelativeImportExtension(specifier));
...
/* harmony export */ });
/* harmony import */ var _api_lazy_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16589);
/* harmony import */ var _auth_context_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18344);
/* harmony import */ var _auth_credential_store_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(43254);
/* harmony import */ var _auth_resolve_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27347);
...
class ModelsImpl {
    ...
    constructor(options) {
        ...
        this.authContext = options?.authContext ?? (0,_auth_context_js__WEBPACK_IMPORTED_MODULE_2__/* .defaultProviderAuthContext */ .w)();
    }
    ...
    async refresh(provider) {
        if (provider !== undefined) {
            ...
            try {
                ...
                if (error instanceof _auth_resolve_js__WEBPACK_IMPORTED_MODULE_0__/* .ModelsError */ .t)
                    throw error;
                throw new _auth_resolve_js__WEBPACK_IMPORTED_MODULE_0__/* .ModelsError */ .t("model_source", `Model refresh failed for ${provider}`, { cause: error });
            }
            return;
        }
    ...
    async getAuth(model) {
        ...
        if (!provider)
            return undefined;
        return (0,_auth_resolve_js__WEBPACK_IMPORTED_MODULE_0__/* .resolveProviderAuth */ .O)(provider, model, this.credentials, this.authContext);
    }
    ...
    async applyAuth(model, options) {
        const resolution = await (0,_auth_resolve_js__WEBPACK_IMPORTED_MODULE_0__/* .resolveProviderAuth */ .O)(this.requireProvider(model), model, this.credentials, this.authContext, {
    ...
    stream(model, context, options) {
        return (0,_api_lazy_js__WEBPACK_IMPORTED_MODULE_3__/* .lazyStream */ .n)(model, async () => {
