...
/* harmony import */ var _openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(79598);
...
const streamSimple = (model, context, options) => {
    ...
    const base = (0,_simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .buildBaseOptions */ .QP)(model, context, options, apiKey);
...
function buildParams(model, context, options, deploymentName, grammarToolInputProperties = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_4__/* .createGrammarToolInputProperties */ .PJ)(context.tools, model.compat?.supportsOpenAIGrammarTools ?? false)) {
    ...
    const params = {
        ...
        input: messages,
        stream: true,
        prompt_cache_key: (0,_openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_10__/* .clampOpenAIPromptCacheKey */ .l)(options?.sessionId),
        store: false,
    };
