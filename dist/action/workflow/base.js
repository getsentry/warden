 ...
 */
export async function setFailed(message) {
...
export async function findClaudeCodeExecutable() {
    ...
    return await setFailed('Claude Code CLI not found. Ensure Claude Code is installed via https://claude.ai/install.sh');
}
// -----------------------------------------------------------------------------
 ...
 */
export async function handleTriggerErrors(triggerErrors, totalTriggers) {
