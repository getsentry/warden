 ...
 */
export declare function setFailed(message: string): Promise<never>;
/**
 ...
 */
export declare function handleTriggerErrors(triggerErrors: string[], totalTriggers: number): Promise<void>;
/**
