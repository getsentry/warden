...
/* harmony import */ var _sdk_usage_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(44759);
/* harmony import */ var _cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(80029);
...
/* harmony import */ var _review_coordination_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(48352);
...
function logFixEvaluation(ev, index, total) {
    ...
    if (ev.usedFallback) {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(line);
    }
    else {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(line);
    }
    if (ev.verdict === 'attempted_failed' && ev.reasoning) {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`        reason: "${ev.reasoning}"`);
    }
}
...
function mergeFixEvaluationResults(results) {
    return {
        ...
        usage: (0,_sdk_usage_js__WEBPACK_IMPORTED_MODULE_22__/* .aggregateUsage */ .Z$)(results.map((result) => result.usage)),
...
async function fetchPreviousReviewInfo(octokit, context) {
    ...
    try {
        ...
        if (!botLogin) {
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)('Skipping dismiss flow: cannot identify bot (using PAT or GITHUB_TOKEN instead of GitHub App)');
            return null;
        }
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to fetch previous review info: ${error}`);
        return null;
    }
}
/**
...
async function setupGitHubState(octokit, context) {
    ...
    try {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Created core check: ${coreCheck.url}`);
    }
    catch (error) {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to create core check: ${error}`);
    }
    previousReviewInfo = await fetchPreviousReviewInfo(octokit, context);
    if (previousReviewInfo) {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Previous Warden review state: ${previousReviewInfo.state}`);
    }
    ...
    if (context.pullRequest) {
        try {
            ...
            if (fetchedComments.length > 0) {
                ...
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Found ${fetchedComments.length} existing comments for deduplication (${wardenCount} Warden, ${externalCount} external)`);
            }
        }
        catch (error) {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to fetch existing comments for deduplication: ${error}`);
        }
    }
    ...
    if (context.pullRequest &&
        ...
        try {
            ...
            if (unresolvedCount > 0) {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Fix evaluation: evaluating ${unresolvedCount} unresolved comments`);
            }
            else {
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Fix evaluation: no eligible comments (${currentHeadCount} current head, ` +
            ...
            if (fixEvaluation.toResolve.length > 0) {
                ...
                if (resolvedCount > 0) {
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Resolved ${resolvedCount} comments via fix evaluation`);
                }
            ...
            if (fixEvaluation.evaluated > 0) {
                ...
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Fix evaluation: ${fixEvaluation.toResolve.length} resolved, ` +
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to evaluate fix attempts: ${error}`);
            (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .logGroupEnd */ .TN)();
        }
    }
    ...
    if (context.pullRequest && wardenComments.length > 0 && canResolveStale) {
        try {
            ...
            if (staleComments.length > 0) {
                ...
                if (resolvedCount > 0) {
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Resolved ${resolvedCount} stale Warden comments`);
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to resolve stale comments: ${error}`);
        }
    }
    else if (!canResolveStale && wardenComments.length > 0) {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)('Skipping stale comment resolution due to trigger failures');
    }
...
async function dismissPreviousReviewIfResolved(octokit, context, previousReviewInfo, results, canResolveStale, options = {}) {
    ...
    if (context.pullRequest &&
        ...
        try {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)('Dismissed previous CHANGES_REQUESTED review');
        }
        catch (error) {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to dismiss previous review: ${error}`);
        }
    }
}
/**
...
async function finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, triggerErrors) {
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .writeFindingsOutput */ .JR)(reports, context, findingObservations, {
            triggerResults: toReplayTriggerResults(results),
        });
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
    }
    catch (error) {
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to write findings output: ${error}`);
    }
    ...
    if (coreCheckId && context.pullRequest) {
        try {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to update core check: ${error}`);
        }
    }
    if (shouldFailAction) {
        (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .setFailed */ .C1)(failureReasons.join('; '));
    }
    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Analysis complete: ${outputs.findingsCount} total findings`);
}
...
async function completeSkippedSkillChecks(octokit, context, skippedTriggers) {
    ...
    for (const trigger of skippedTriggers) {
        try {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to update skipped skill check for ${trigger.skill}: ${error}`);
        }
    }
}
/**
...
async function failUndispatchedSkillChecks(octokit, context, triggers, error) {
    ...
    for (const trigger of triggers) {
        try {
            ...
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to mark skill check as failed for ${trigger.skill}: ${checkError}`);
        }
    }
}
/**
...
async function failCoreCheck(octokit, context, coreCheckId, error) {
    ...
    try {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to mark core check as failed: ${checkError}`);
    }
}
...
async function createCompletedCoreCheckForReport(octokit, context, results, reports, shouldFailAction, outputs, overrides = {}, conclusion) {
    ...
    await (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_17__/* .createCompletedCoreCheck */ .RR)(octokit, {
        ...
        ...overrides,
    }, conclusion ?? (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_17__/* .determineCoreConclusion */ .ar)(shouldFailAction, outputs.findingsCount), options);
}
/**
...
async function createFailedCoreCheckForReport(octokit, context, error) {
    ...
    try {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to create failed core check: ${checkError}`);
    }
}
/**
...
async function cleanupOrphanedComments(octokit, context, inputs, auxiliaryOptions, options = {}) {
    ...
    try {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to fetch existing comments for cleanup: ${error}`);
        return [];
    }
    ...
    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`No triggers matched, but found ${wardenComments.length} existing Warden comments. Running cleanup.`);
...
async function runAnalyzeMode(inputs, initResult, span) {
    ...
    if (skipCoreCheck || matchedTriggers.length === 0) {
        ...
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)('Analysis complete: 0 total findings');
        return;
    }
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .writeFindingsOutput */ .JR)(reports, context, [], {
            triggerResults: toReplayTriggerResults(results),
        });
        (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
    }
...
async function runReportMode(octokit, inputs, initResult, repoPath, span) {
    ...
    try {
        ...
        if (matchedTriggers.length === 0) {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .setWorkflowOutputs */ .wZ)(outputs);
            try {
                const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations, {
                    triggerResults: [],
                });
                (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
            }
        ...
        canResolveStale = (0,_review_coordination_js__WEBPACK_IMPORTED_MODULE_23__/* .shouldResolveStaleComments */ .t)(results);
    ...
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.run', name: 'review pull_request' }, async (span) => {
        ...
        if (matchedTriggers.length === 0) {
            await runOrFailCore(octokit, context, coreCheckId, async () => {
                ...
                try {
                    (0,_base_js__WEBPACK_IMPORTED_MODULE_18__/* .writeFindingsOutput */ .JR)([], context, cleanupFindingObservations);
                }
                catch (error) {
                    (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_21__/* .warnAction */ .T6)(`Failed to write findings output: ${error}`);
                }
        ...
        const canResolveStale = (0,_review_coordination_js__WEBPACK_IMPORTED_MODULE_23__/* .shouldResolveStaleComments */ .t)(results);
        const allFindings = reviewPhase.reports.flatMap((r) => r.findings);
        span.setAttribute('warden.finding.count', allFindings.length);
