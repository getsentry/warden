...
async function analyzeHunk(skill, hunkCtx, repoPath, options, callbacks, prContext, parentSpan) {
    ...
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({
        ...
        const systemPrompt = (0,_prompt_js__WEBPACK_IMPORTED_MODULE_6__/* .buildHunkSystemPrompt */ .qE)(skill, options.historicalEvidence);
        const userPrompt = (0,_prompt_js__WEBPACK_IMPORTED_MODULE_6__/* .buildHunkUserPrompt */ ._R)(skill, hunkCtx, prContext);
...
function splitMergeGroupByClaim(findings, indices) {
    const claims = new Map();
    for (const index of indices) {
        const finding = findings[index - 1];
        if (!finding || !finding.title.trim() || !finding.description.trim())
            continue;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   WE: () => (/* binding */ buildSkillResourcesSection),
/* harmony export */   _R: () => (/* binding */ buildHunkUserPrompt),
/* harmony export */   qE: () => (/* binding */ buildHunkSystemPrompt)
/* harmony export */ });
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73024);
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(node_fs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76760);
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(node_path__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _skills_resources_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18771);
...
function buildSkillResourcesSection(skill) {
    const { rootDir } = skill;
    if (!rootDir)
        return undefined;
    const resourceDirs = _skills_resources_js__WEBPACK_IMPORTED_MODULE_4__/* .SKILL_RESOURCE_DIRECTORIES */ .j.filter((dir) => (0,node_fs__WEBPACK_IMPORTED_MODULE_0__.existsSync)((0,node_path__WEBPACK_IMPORTED_MODULE_1__.join)(rootDir, dir)));
...
/* harmony export */ });
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(32253);
/* harmony import */ var _types_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78481);
/* harmony import */ var _usage_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(44759);
/* harmony import */ var _extract_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29709);
/* harmony import */ var _prompt_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12204);
/* harmony import */ var _errors_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(98229);
/* harmony import */ var _runtimes_index_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(23473);
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(82272);
/* harmony import */ var _prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(49893);
...
const VerificationVerdictSchema = zod__WEBPACK_IMPORTED_MODULE_7__/* .object */ .Ik({
    verdict: zod__WEBPACK_IMPORTED_MODULE_7__/* ["enum"] */ .k5(['keep', 'revise', 'reject']),
...
${(0,_prompt_js__WEBPACK_IMPORTED_MODULE_2__/* .buildSkillResourcesSection */ .WE)(skill) ?? ''}
...
${(0,_prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__/* .buildJsonOutputSection */ .j2)(`
...
function buildVerificationUserPrompt(finding, prContext) {
    return (0,_prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__/* .joinPromptSections */ .hZ)([
        (0,_prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__/* .buildPullRequestContextSection */ .Dg)(prContext),
        (0,_prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__/* .buildChangedFilesSection */ .Pq)(prContext, finding.location?.path),
        (0,_prompt_sections_js__WEBPACK_IMPORTED_MODULE_6__/* .buildTaggedSection */ .sG)('candidate_finding', JSON.stringify(finding, null, 2)),
        `<task>
...
function throwIfAuthenticationFailure(authError, result, runtime) {
    if (authError) {
        throw new _errors_js__WEBPACK_IMPORTED_MODULE_3__/* .WardenAuthenticationError */ .Aq(authError, { runtime });
    }
    if (!result)
        return;
    const authMessage = result.errors.find(_errors_js__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticationErrorMessage */ .Ip);
    if (result.status === 'auth_error') {
        throw new _errors_js__WEBPACK_IMPORTED_MODULE_3__/* .WardenAuthenticationError */ .Aq(authMessage, { runtime });
    }
    if (authMessage) {
        throw new _errors_js__WEBPACK_IMPORTED_MODULE_3__/* .WardenAuthenticationError */ .Aq(authMessage, { runtime });
    }
...
async function verifyFindings(findings, options) {
    ...
    const runtimeName = options.runtime ?? 'pi';
    const runtime = (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_4__/* .getRuntime */ .fr)(runtimeName);
    const systemPrompt = buildVerificationSystemPrompt(options.skill);
    const results = await (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_5__/* .runPool */ .kD)(findings, VERIFICATION_CONCURRENCY, async (finding) => {
        ...
        try {
            const { result, authError } = await runtime.runSkill({
                ...
                providerOptions: (0,_runtimes_index_js__WEBPACK_IMPORTED_MODULE_4__/* .getRuntimeProviderOptions */ .g_)(runtimeName, {
                    pathToClaudeCodeExecutable: options.pathToClaudeCodeExecutable,
                }),
            });
            ...
            if ((0,_errors_js__WEBPACK_IMPORTED_MODULE_3__/* .isAuthenticationError */ .HD)(error)) {
                throw new _errors_js__WEBPACK_IMPORTED_MODULE_3__/* .WardenAuthenticationError */ .Aq(undefined, { runtime: runtimeName, cause: error });
            }
            return { finding };
        }
    });
    ...
    return {
        findings: verified,
        usage: usage.length > 0 ? (0,_usage_js__WEBPACK_IMPORTED_MODULE_8__/* .aggregateUsage */ .Z$)(usage) : undefined,
