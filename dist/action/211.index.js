...
const FindingObservationSchema = schemas/* discriminatedUnion */.gM('outcome', [
    ...
    schemas/* object */.Ik({
        ...
        skill: schemas/* string */.Yj().optional(),
        skillExecutionId: schemas/* string */.Yj().optional(),
        skippedReason: schemas/* enum */.k5(['max_findings', 'duplicate_in_batch', 'no_inline_location', 'review_not_posted']),
    }),
    schemas/* object */.Ik({
...
;// CONCATENATED MODULE: ./src/action/reporting/provenance.ts
...
// EXTERNAL MODULE: ./src/action/reporting/output.ts + 2 modules
var reporting_output = __webpack_require__(74577);
...
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(98514);
/* harmony import */ var _output_renderer_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(21242);
/* harmony import */ var _reporting_output_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(74577);
...
function toSkillExecutions(results) {
    return results
        ...
        // currently read from.
        checkConclusion: (0,_checks_manager_js__WEBPACK_IMPORTED_MODULE_18__/* .determineConclusion */ .Hx)((0,_types_index_js__WEBPACK_IMPORTED_MODULE_8__/* .filterFindings */ .Ni)(r.report.findings, undefined, r.minConfidence), r.failOn, r.failCheck),
...
async function executeAllTriggers(matchedTriggers, context, runnerConcurrency, inputs, options = {}) {
    ...
    const results = await (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_9__/* .runPool */ .kD)(matchedTriggers, concurrency, async (trigger) => {
        const result = await (0,_triggers_executor_js__WEBPACK_IMPORTED_MODULE_13__/* .executeTrigger */ .k)(trigger, {
            context,
 ...
 */
async function finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, gate, triggerErrors, skippedTriggers, inputs) {
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)(reports, context, findingObservations, {
            ...
            ...(0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildBaseOutputOptions */ .vM)(inputs, [
...
async function finalizeReportWorkflow(octokit, context, previousReviewInfo, results, reports, findingObservations, shouldFailAction, failureReasons, canResolveStale, gate, triggerErrors, options) {
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)(reports, context, findingObservations, {
            triggerResults: toReplayTriggerResults(results),
            ...(0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildBaseOutputOptions */ .vM)(options.inputs, [
...
async function runAnalyzeMode(inputs, initResult, span) {
    const { context, runnerConcurrency, matchedTriggers, skippedTriggers, skipCoreCheck, } = initResult;
    if (skipCoreCheck || matchedTriggers.length === 0) {
        ...
        try {
            const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutput */ .JR)([], context, [], {
                triggerResults: [],
                ...(0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildBaseOutputOptions */ .vM)(inputs, toSkippedTriggers(skippedTriggers, context)),
            });
            (0,_cli_output_tty_js__WEBPACK_IMPORTED_MODULE_22__/* .logAction */ .d5)(`Findings written to ${findingsPath}`);
        }
        catch (error) {
    ...
    const results = await _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({
        ...
        onTriggerComplete: (completedSoFar) => {
            ...
            (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .writeFindingsOutputLive */ .ZU)(reportsSoFar, context, [], {
                ...(0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_21__/* .buildBaseOutputOptions */ .vM)(inputs, [
                    ...toSkippedTriggers(skippedTriggers, context),
...
async function runReportMode(octokit, inputs, initResult, repoPath, span) {
    ...
    try {
        ...
        await finalizeReportWorkflow(octokit, context, previousReviewInfo, results, reviewPhase.reports, reviewPhase.findingObservations, reviewPhase.shouldFailAction, reviewPhase.failureReasons, canResolveStale, gate, triggerErrors, { failOnWriteError: true, skippedTriggers, inputs });
    }
    catch (error) {
...
async function runPRWorkflow(octokit, inputs, eventName, eventPath, repoPath) {
    ...
    const preservePayload = reportInputPath !== undefined
        && (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)(reportInputPath) === (0,node_path__WEBPACK_IMPORTED_MODULE_1__.resolve)((0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .getFindingsOutputPath */ .Rr)(repoPath));
    (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .clearStaleFindingsOutput */ .mG)(repoPath, { preservePayload });
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'workflow.run', name: 'review pull_request' }, async (span) => {
        ...
        await finalizeWorkflow(octokit, context, previousReviewInfo, coreCheckId, results, reviewPhase.reports, reviewPhase.findingObservations, reviewPhase.shouldFailAction, reviewPhase.failureReasons, canResolveStale, gate, triggerErrors, skippedTriggers, inputs);
        (0,_base_js__WEBPACK_IMPORTED_MODULE_19__/* .handleTriggerErrors */ .a3)(triggerErrors, matchedTriggers.length);
    });
}
...
/* harmony import */ var _reporting_output_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(74577);
/* harmony import */ var _base_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(98514);
...
async function runScheduleWorkflowInner(octokit, inputs, repoPath, workflowSpan) {
    ...
    (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .clearStaleFindingsOutput */ .mG)(repoPath);
        ...
        if (error instanceof _config_loader_js__WEBPACK_IMPORTED_MODULE_0__/* .ConfigLoadError */ .tx &&
            ...
            try {
                ...
                (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .writeFindingsOutput */ .JR)([], {
                    ...
                    repoPath,
                }, [], (0,_reporting_output_js__WEBPACK_IMPORTED_MODULE_9__/* .buildBaseOutputOptions */ .vM)(inputs, []));
            }
            catch (writeError) {
    ...
    const writeLiveSnapshot = (processedCount) => {
        ...
        (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .writeFindingsOutputLive */ .ZU)([...allReports], scheduleContext, [], {
    ...
    for (const [triggerIndex, resolved] of scheduleTriggers.entries()) {
        ...
        try {
            ...
            const ignorePatterns = [
                ...
                _base_js__WEBPACK_IMPORTED_MODULE_10__/* .FINDINGS_OUTPUT_FILENAME */ .X0,
                _base_js__WEBPACK_IMPORTED_MODULE_10__/* .FINDINGS_OUTPUT_DONE_FILENAME */ .GF,
            ];
    ...
    try {
        const findingsPath = (0,_base_js__WEBPACK_IMPORTED_MODULE_10__/* .writeFindingsOutput */ .JR)(allReports, scheduleContext, [], {
...
/* harmony import */ var _sdk_report_files_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(79418);
/* harmony import */ var chalk__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(39559);
/* harmony import */ var figures__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(58653);
/* harmony import */ var _verbosity_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(21307);
/* harmony import */ var _icons_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(5832);
    ...
    return _sentry_js__WEBPACK_IMPORTED_MODULE_1__/* .Sentry.startSpan */ .sQ.startSpan({ op: 'skill.run', name: `run ${displayName}` }, async (span) => {
        ...
        try {
            ...
            const processFile = async (prepared, index) => {
                ...
                const result = await (0,_sdk_runner_js__WEBPACK_IMPORTED_MODULE_3__/* .analyzeFile */ .xy)(skill, prepared, context.repoPath, runnerOptions, fileCallbacks, prContext);
            ...
            const allResults = await (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_7__/* .runPool */ .kD)(preparedFiles, fileConcurrency, async (file, index) => {
                if (semaphore)
            ...
            const report = {
                ...
                model: runnerOptions?.model,
                runtime,
                files: (0,_sdk_report_files_js__WEBPACK_IMPORTED_MODULE_10__/* .buildFileReports */ .K)(preparedFiles.map((file, i) => {
                    const r = allResults[i];
                    return {
                        filename: file.filename,
                        durationMs: r?.durationMs,
...
function createDefaultCallbacks(tasks, mode, verbosity) {
    ...
    return {
        ...
        onSkillComplete: (name, report) => {
            ...
            if (mode.isTTY) {
                const duration = report.durationMs !== undefined ? ` ${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.dim(`[${(0,_formatters_js__WEBPACK_IMPORTED_MODULE_6__/* .formatDuration */ .a3)(report.durationMs)}]`)}` : '';
                console.error(`${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.green(_icons_js__WEBPACK_IMPORTED_MODULE_11__/* .ICON_CHECK */ .hP)} ${displayName}${duration}`);
        ...
        onSkillSkipped: (name) => {
            ...
            const displayName = displayNameFor(name);
            if (mode.isTTY) {
                console.error(`${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.yellow(_icons_js__WEBPACK_IMPORTED_MODULE_11__/* .ICON_SKIPPED */ .xj)} ${displayName} ${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.dim('[skipped]')}`);
            }
            else {
        ...
        onLargePrompt: (_skillName, filename, lineRange, chars, estimatedTokens) => {
            ...
            const size = `${Math.round(chars / 1000)}k chars (~${Math.round(estimatedTokens / 1000)}k tokens)`;
            if (mode.isTTY) {
                console.error(`${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.yellow(figures__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Ay.warning)}  Large prompt for ${location}: ${size}`);
            }
            else {
        ...
        onHunkFailed: verbosity >= _verbosity_js__WEBPACK_IMPORTED_MODULE_5__/* .Verbosity */ .W.Verbose
            ? (_skillName, filename, lineRange, error) => {
                const location = `${filename}:${lineRange}`;
                if (mode.isTTY) {
                    console.error(`${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.yellow(figures__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Ay.warning)}  Chunk failed: ${location} ${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.dim(`\u2014 ${error}`)}`);
                }
                else {
        ...
        onExtractionFailure: verbosity >= _verbosity_js__WEBPACK_IMPORTED_MODULE_5__/* .Verbosity */ .W.Verbose
            ? (_skillName, filename, lineRange, error, preview) => {
                const location = `${filename}:${lineRange}`;
                if (mode.isTTY) {
                    console.error(`${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.yellow(figures__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Ay.warning)}  Extraction failed: ${location} ${chalk__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Ay.dim(`\u2014 ${error}`)}`);
...
/* harmony import */ var smol_toml__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46394);
...
async function analyzeHunk(skill, hunkCtx, repoPath, options, callbacks, prContext) {
    ...
    return _sentry_js__WEBPACK_IMPORTED_MODULE_2__/* .Sentry.startSpan */ .sQ.startSpan({
        ...
        const systemPrompt = (0,_prompt_js__WEBPACK_IMPORTED_MODULE_6__/* .buildHunkSystemPrompt */ .q)(skill);
...
async function runSkillAnalysis(skill, context, options = {}) {
    ...
    if (parallel) {
        // Process files with sliding-window concurrency pool
        const fileConcurrency = options.concurrency ?? _types_js__WEBPACK_IMPORTED_MODULE_14__/* .DEFAULT_FILE_CONCURRENCY */ .f;
        const batchDelayMs = options.batchDelayMs ?? 0;
        fileResults.push(...await (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_11__/* .runPool */ .kD)(fileHunks, fileConcurrency, async (fileHunkEntry, index) => {
            // Rate-limit: delay items beyond the first concurrent wave
