...
/* harmony import */ var _models_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(15403);
/* harmony import */ var _utils_error_body_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(298);
/* harmony import */ var _utils_event_stream_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57868);
/* harmony import */ var _utils_hash_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(13911);
/* harmony import */ var _utils_headers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(70957);
/* harmony import */ var _utils_json_parse_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(43235);
/* harmony import */ var _utils_provider_env_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81844);
/* harmony import */ var _utils_provider_retry_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29845);
/* harmony import */ var _utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(76994);
/* harmony import */ var _constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(55214);
/* harmony import */ var _github_copilot_headers_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(83933);
/* harmony import */ var _openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(79598);
/* harmony import */ var _simple_options_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(402);
/* harmony import */ var _transform_messages_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(56403);
...
const streamSimple = (model, context, options) => {
    ...
    const base = (0,_simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .buildBaseOptions */ .QP)(model, context, options, options?.apiKey);
...
function createClient(model, context, apiKey, optionsHeaders, fetch, sessionId, compat = getCompat(model)) {
    ...
    if (model.provider === "github-copilot") {
        const hasImages = (0,_github_copilot_headers_js__WEBPACK_IMPORTED_MODULE_10__/* .hasCopilotVisionInput */ .d1)(context.messages);
        const copilotHeaders = (0,_github_copilot_headers_js__WEBPACK_IMPORTED_MODULE_10__/* .buildCopilotDynamicHeaders */ .G0)({
...
function buildParams(model, context, options, compat = getCompat(model), cacheRetention = resolveCacheRetention(options?.cacheRetention, options?.env), grammarToolInputProperties = (0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .createGrammarToolInputProperties */ .PJ)(context.tools, compat.supportsOpenAIGrammarTools)) {
    ...
    const params = {
        ...
        prompt_cache_key: (model.baseUrl.includes("api.openai.com") && cacheRetention !== "none") ||
            ...
            ? (0,_openai_prompt_cache_js__WEBPACK_IMPORTED_MODULE_11__/* .clampOpenAIPromptCacheKey */ .l)(options?.sessionId)
            : undefined,
    ...
    if (compat.supportsThinkingTokenBudget && options?.reasoningEffort && model.reasoning) {
        const level = (0,_simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .clampReasoning */ .M7)(options.reasoningEffort);
        const budgets = {
            minimal: 1024,
            low: 2048,
            medium: 8192,
        ...
        const budget = Math.min(budgets[level], Math.max(0, ceiling - _simple_options_js__WEBPACK_IMPORTED_MODULE_8__/* .MIN_ANSWER_TOKENS */ .t_));
        if (budget > 0) {
...
function convertMessages(model, context, compat, options) {
    ...
    const normalizeToolCallId = (id) => {
        ...
        if (id.includes("|")) {
            ...
            const hash = (0,_utils_hash_js__WEBPACK_IMPORTED_MODULE_12__/* .shortHash */ .B)(id).slice(0, 8);
    ...
    const transformedMessages = (0,_transform_messages_js__WEBPACK_IMPORTED_MODULE_13__/* .transformMessages */ .b)(context.messages, model, (id) => normalizeToolCallId(id));
    if (context.systemPrompt) {
        const useDeveloperRole = model.reasoning && compat.supportsDeveloperRole;
        const role = useDeveloperRole ? "developer" : "system";
        params.push({ role: role, content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(context.systemPrompt) });
    }
    let lastRole = null;
    for (let i = 0; i < transformedMessages.length; i++) {
        ...
        if (msg.role === "user") {
            if (typeof msg.content === "string") {
                params.push({
                    role: "user",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(msg.content),
                });
            }
            else {
                const content = msg.content.map((item) => {
                    if (item.type === "text") {
                        return {
                            type: "text",
                            text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(item.text),
                        };
                    }
                    else {
                        return {
            ...
            const assistantTextParts = msg.content
                ...
                .map((block) => ({
                type: "text",
                text: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(block.text),
            }));
            ...
            if (nonEmptyThinkingBlocks.length > 0) {
                if (compat.requiresThinkingAsText) {
                    ...
                    const thinkingText = nonEmptyThinkingBlocks
                        .map((block) => (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(block.thinking))
                        .join("\n\n");
                ...
                assistantMsg.tool_calls = toolCalls.map((tc) => {
                    ...
                    if (customInputProperty !== undefined) {
                        return {
                            ...
                            custom: {
                                name: tc.name,
                                input: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)((0,_constrained_sampling_js__WEBPACK_IMPORTED_MODULE_3__/* .getGrammarToolInput */ .gY)(tc.name, tc.arguments, customInputProperty)),
                            },
                        };
                    }
                    return {
            ...
            for (; j < transformedMessages.length && transformedMessages[j].role === "toolResult"; j++) {
                ...
                const toolResultMsg = {
                    role: "tool",
                    content: (0,_utils_sanitize_unicode_js__WEBPACK_IMPORTED_MODULE_14__/* .sanitizeSurrogates */ .J)(toolResultText),
