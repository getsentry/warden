...
| `cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6` | `WARDEN_CLOUDFLARE_API_KEY` + `CLOUDFLARE_ACCOUNT_ID` |
...
slashes. For example, `cloudflare-workers-ai/@cf/moonshotai/kimi-k2.6` sets
provider `cloudflare-workers-ai` and model ID `@cf/moonshotai/kimi-k2.6`.
