...
The stable rows point in three directions. GPT 5.5 high remains the strongest
recall row on this corpus. Sonnet 4.6 and Opus 4.6 remain the strongest Claude
baselines. DeepSeek V4 Pro is competitive with Opus 4.6 on recall and cheaper
to run, while V4 Flash is cheaper again but gives up known-corpus coverage and
has much worse latency.
